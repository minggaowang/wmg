<#if Session["LOGIN_USER"]?exists && Session[Session["LOGIN_USER"]]?exists>
    <#assign agentSession = Session[Session["LOGIN_USER"]]>
</#if>
<#if agentSession??>
                    ...
                    <#if LOGIN_USER ??>
                        ...
                        <li class="user-profile dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-animated pop-effect closed" role="menu">
                                <li><a href="<@spring.url '/userInfo/toInformation'/>">基本信息</a></li>
                                <li><a href="<@spring.url '/userInfo/toModifyPassword'/>">修改密码</a></li>
                                <li><a href="<@spring.url '/loginAccredit/index'/>">注册授权</a></li>
                                <li><a href="<@spring.url '/systemUpdate/index'/>">产品升级</a></li>
                                <li><a href="<@spring.url '/workorder/myQuestion'/>">我的问题</a></li>
                                <li><a href="<@spring.url '/workorder/submitQuestion'/>">提交问题</a></li>
                                <li><a href="<@spring.url '/knowledge/toMonitorList'/>">在线知识库</a></li>
                    ...
                    <#if LOGIN_USER ??>
                        ...
                        <li class="user-profile dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-animated pop-effect closed" role="menu">
                                ...
                                <li><a href="<@spring.url '/workorder/submitQuestion'/>">提交问题</a></li>
                                <li><a href="<@spring.url '/knowledge/toMonitorList'/>">在线知识库</a></li>
                                <li><a href="javascript:saascommunity.userManage.doLogout();">退出</a></li>
                            </ul>
                        </li>
                    <#else>
                        <li class="dropdown-icon hidden-xs hidden-sm" id="login_other">
...
<script type="text/javascript">
    $(function(){
        ...
        if(document.title=="门户"){
            ...
            $("#login_other").empty().append(" <a id='loginButton' href='javascript:saascommunity.userManage.loginButton();' class='login'><span><i class='fa fa-user'></i>登录</span></a>");
        }
